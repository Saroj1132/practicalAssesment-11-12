...
class GamesSeeder {
    ...
    async seed() {
        ...
        for (const game of games) {
            try {
                await this.databaseService.query('INSERT INTO games (title, platform, score, genre, editors_choice) VALUES (?, ?, ?, ?, ?)', [game.title, game.platform, game.score, game.genre, game.editors_choice]);
            }
            catch (error) {
...
exports.GamesSeeder = GamesSeeder;
//# sourceMappingURL=games.seeder.js.map